			...
			class MH_Table_Rate_Shipping_Method extends WC_Shipping_Method {
				...
				?>
					...
					<div class="updated woocommerce-message">
						<p><strong>Check out our <a href="https://mangohour.com/plugins/woocommerce-table-rate-shipping?utm_source=wordpress&utm_medium=wctr_plugin_settings" target="_blank">premium version</a> for extra features and support</strong></p>
						<p><strong>Including:</strong>
							<span class="dashicons dashicons-yes"></span>Delivery options
							<span class="dashicons dashicons-yes"></span>Postal codes and ZIPs
							<span class="dashicons dashicons-yes"></span>State zones
							<span class="dashicons dashicons-yes"></span>Shipping classes
							<span class="dashicons dashicons-yes"></span>Quantity rates
							<span class="dashicons dashicons-yes"></span>Per item/kg/lbs costs
							<span class="dashicons dashicons-yes"></span>Easy backups
						</p>
						<p class="submit"><a href="https://mangohour.com/plugins/woocommerce-table-rate-shipping?utm_source=wordpress&utm_medium=wctr_plugin_settings" target="_blank" class="button-primary debug-report">Go to Table Rate Shipping Plus+ website</a></p>
					</div>
